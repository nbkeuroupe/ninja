...
class ProtocolHandler:
    ...
    def __init__(self, protocol_name: str):
        ...
        if protocol_name not in settings.PROTOCOLS:
            raise ValueError(f"Invalid protocol: {protocol_name}")
        
        self.protocol_name = protocol_name
        self.protocol_config = settings.PROTOCOLS[protocol_name]
...
class MTIHandler:
    ...
    def validate_mti(mti: str) -> bool:
        ...
        Returns:
            bool: True if valid, False otherwise
        """
        return mti in settings.MTI_TYPES
    ...
    def get_mti_description(mti: str) -> str:
        ...
        """
        if mti in settings.MTI_TYPES:
            return settings.MTI_TYPES[mti]
        return "Unknown MTI"
